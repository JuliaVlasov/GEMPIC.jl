@testset "VM 1D1V with spin" begin
    ...
    ref = [
        3.127970342747129 4.691955514120693
    ...
    @test efield_dofs[3] ≈ [
        -1.0681800094815476e-5,
        1.6022700129154877e-5,
        -2.136360014868184e-5,
        2.670450014853168e-5,
        -3.204540010485847e-5,
        3.738630007371513e-5,
        -4.272719996293515e-5,
        4.806809980886038e-5,
    ]
    @test afield_dofs[1] ≈ [
        8.824412992125462e-7,
        -1.3236619477267236e-6,
        1.7648825950343306e-6,
        -2.2061032407091485e-6,
        2.6473238828043315e-6,
        -3.088544525898473e-6,
        3.5297651624492664e-6,
        -3.970985795411606e-6,
    ]
    @test afield_dofs[2] ≈ [
        -0.014105653210181833,
        0.01410565317567925,
        -0.014105653127374468,
        0.014105653065269032,
        -0.01410565298936165,
        0.014105652899653832,
        -0.014105652796145382,
        0.014105652678833834,
    ]

    propagator = HamiltonianSplittingSpin(
        maxwell_solver,
        kernel_smoother0,
        kernel_smoother1,
        kernel_smoother2,
    ...
    @test efield_poisson ≈ [-0.572, -0.848, -2.759, 1.417, -1.420, 2.761, 0.848, 0.573] atol =
        1e-2
