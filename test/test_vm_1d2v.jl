...
@testset " PIC VM 1D2V " begin
    ...
    kernel_smoother1 = ParticleMeshCoupling1D(mesh, n_particles, spline_degree, :galerkin)
    ...
    solve_poisson!(efield_dofs[1], particle_group, kernel_smoother0, maxwell_solver, rho)
